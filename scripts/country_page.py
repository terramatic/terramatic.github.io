...
THUMBS_DIR = r'''/mnt/c/xampp/htdocs/travelmatic/images/thumbs/{c}'''.format(c=country)
HTML_DIR = r'/mnt/c/xampp/htdocs/travelmatic/countries'
	...
	<body class="is-preload-0 is-preload-1 is-preload-2">
		<!-- Main -->
			<div id="main">
				...
				<footer id="footer">
					<ul class="icons">						
						<li><a href="https://www.instagram.com/travelmatic" class="icon alt fa-instagram"><span class="label">Instagram</span></a></li>
